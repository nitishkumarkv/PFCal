...
namespace ROOT {
   static void *new_HGCSSFirstHadInt(void *p = 0);
   static void *newArray_HGCSSFirstHadInt(Long_t size, void *p);
   static void delete_HGCSSFirstHadInt(void *p);
   static void deleteArray_HGCSSFirstHadInt(void *p);
   static void destruct_HGCSSFirstHadInt(void *p);

   // Function generating the singleton type initializer
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::HGCSSFirstHadInt*)
   {
      ::HGCSSFirstHadInt *ptr = 0;
      static ::TVirtualIsAProxy* isa_proxy = new ::TInstrumentedIsAProxy< ::HGCSSFirstHadInt >(0);
      static ::ROOT::TGenericClassInfo 
         instance("HGCSSFirstHadInt", ::HGCSSFirstHadInt::Class_Version(), "HGCSSFirstHadInt.hh", 16,
                  typeid(::HGCSSFirstHadInt), ::ROOT::Internal::DefineBehavior(ptr, ptr),
                  &::HGCSSFirstHadInt::Dictionary, isa_proxy, 4,
                  sizeof(::HGCSSFirstHadInt) );
      instance.SetNew(&new_HGCSSFirstHadInt);
      instance.SetNewArray(&newArray_HGCSSFirstHadInt);
      instance.SetDelete(&delete_HGCSSFirstHadInt);
      instance.SetDeleteArray(&deleteArray_HGCSSFirstHadInt);
      instance.SetDestructor(&destruct_HGCSSFirstHadInt);
      return &instance;
   }
   TGenericClassInfo *GenerateInitInstance(const ::HGCSSFirstHadInt*)
   {
      return GenerateInitInstanceLocal((::HGCSSFirstHadInt*)0);
   }
   // Static variable to force the class initialization
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_DICT_(Init) = GenerateInitInstanceLocal((const ::HGCSSFirstHadInt*)0x0); R__UseDummy(_R__UNIQUE_DICT_(Init));
} // end of namespace ROOT

namespace ROOT {
   static void *new_HGCSSpi0Info(void *p = 0);
   static void *newArray_HGCSSpi0Info(Long_t size, void *p);
   static void delete_HGCSSpi0Info(void *p);
   static void deleteArray_HGCSSpi0Info(void *p);
   static void destruct_HGCSSpi0Info(void *p);

   // Function generating the singleton type initializer
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::HGCSSpi0Info*)
   {
      ::HGCSSpi0Info *ptr = 0;
      static ::TVirtualIsAProxy* isa_proxy = new ::TInstrumentedIsAProxy< ::HGCSSpi0Info >(0);
      static ::ROOT::TGenericClassInfo 
         instance("HGCSSpi0Info", ::HGCSSpi0Info::Class_Version(), "HGCSSpi0Info.hh", 16,
                  typeid(::HGCSSpi0Info), ::ROOT::Internal::DefineBehavior(ptr, ptr),
                  &::HGCSSpi0Info::Dictionary, isa_proxy, 4,
                  sizeof(::HGCSSpi0Info) );
      instance.SetNew(&new_HGCSSpi0Info);
      instance.SetNewArray(&newArray_HGCSSpi0Info);
      instance.SetDelete(&delete_HGCSSpi0Info);
      instance.SetDeleteArray(&deleteArray_HGCSSpi0Info);
      instance.SetDestructor(&destruct_HGCSSpi0Info);
      return &instance;
   }
   TGenericClassInfo *GenerateInitInstance(const ::HGCSSpi0Info*)
   {
      return GenerateInitInstanceLocal((::HGCSSpi0Info*)0);
   }
   // Static variable to force the class initialization
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_DICT_(Init) = GenerateInitInstanceLocal((const ::HGCSSpi0Info*)0x0); R__UseDummy(_R__UNIQUE_DICT_(Init));
} // end of namespace ROOT
...
//______________________________________________________________________________
atomic_TClass_ptr HGCSSFirstHadInt::fgIsA(0);  // static to hold class pointer

//______________________________________________________________________________
const char *HGCSSFirstHadInt::Class_Name()
{
   return "HGCSSFirstHadInt";
}

//______________________________________________________________________________
const char *HGCSSFirstHadInt::ImplFileName()
{
   return ::ROOT::GenerateInitInstanceLocal((const ::HGCSSFirstHadInt*)0x0)->GetImplFileName();
}

//______________________________________________________________________________
int HGCSSFirstHadInt::ImplFileLine()
{
   return ::ROOT::GenerateInitInstanceLocal((const ::HGCSSFirstHadInt*)0x0)->GetImplFileLine();
}

//______________________________________________________________________________
TClass *HGCSSFirstHadInt::Dictionary()
{
   fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::HGCSSFirstHadInt*)0x0)->GetClass();
   return fgIsA;
}

//______________________________________________________________________________
TClass *HGCSSFirstHadInt::Class()
{
   if (!fgIsA.load()) { R__LOCKGUARD(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::HGCSSFirstHadInt*)0x0)->GetClass(); }
   return fgIsA;
}

//______________________________________________________________________________
atomic_TClass_ptr HGCSSpi0Info::fgIsA(0);  // static to hold class pointer

//______________________________________________________________________________
const char *HGCSSpi0Info::Class_Name()
{
   return "HGCSSpi0Info";
}

//______________________________________________________________________________
const char *HGCSSpi0Info::ImplFileName()
{
   return ::ROOT::GenerateInitInstanceLocal((const ::HGCSSpi0Info*)0x0)->GetImplFileName();
}

//______________________________________________________________________________
int HGCSSpi0Info::ImplFileLine()
{
   return ::ROOT::GenerateInitInstanceLocal((const ::HGCSSpi0Info*)0x0)->GetImplFileLine();
}

//______________________________________________________________________________
TClass *HGCSSpi0Info::Dictionary()
{
   fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::HGCSSpi0Info*)0x0)->GetClass();
   return fgIsA;
}

//______________________________________________________________________________
TClass *HGCSSpi0Info::Class()
{
   if (!fgIsA.load()) { R__LOCKGUARD(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::HGCSSpi0Info*)0x0)->GetClass(); }
   return fgIsA;
}
...
//______________________________________________________________________________
void HGCSSFirstHadInt::Streamer(TBuffer &R__b)
{
   // Stream an object of class HGCSSFirstHadInt.

   if (R__b.IsReading()) {
      R__b.ReadClassBuffer(HGCSSFirstHadInt::Class(),this);
   } else {
      R__b.WriteClassBuffer(HGCSSFirstHadInt::Class(),this);
   }
}

namespace ROOT {
   // Wrappers around operator new
   static void *new_HGCSSFirstHadInt(void *p) {
      return  p ? new(p) ::HGCSSFirstHadInt : new ::HGCSSFirstHadInt;
   }
   static void *newArray_HGCSSFirstHadInt(Long_t nElements, void *p) {
      return p ? new(p) ::HGCSSFirstHadInt[nElements] : new ::HGCSSFirstHadInt[nElements];
   }
   // Wrapper around operator delete
   static void delete_HGCSSFirstHadInt(void *p) {
      delete ((::HGCSSFirstHadInt*)p);
   }
   static void deleteArray_HGCSSFirstHadInt(void *p) {
      delete [] ((::HGCSSFirstHadInt*)p);
   }
   static void destruct_HGCSSFirstHadInt(void *p) {
      typedef ::HGCSSFirstHadInt current_t;
      ((current_t*)p)->~current_t();
   }
} // end of namespace ROOT for class ::HGCSSFirstHadInt

//______________________________________________________________________________
void HGCSSpi0Info::Streamer(TBuffer &R__b)
{
   // Stream an object of class HGCSSpi0Info.

   if (R__b.IsReading()) {
      R__b.ReadClassBuffer(HGCSSpi0Info::Class(),this);
   } else {
      R__b.WriteClassBuffer(HGCSSpi0Info::Class(),this);
   }
}

namespace ROOT {
   // Wrappers around operator new
   static void *new_HGCSSpi0Info(void *p) {
      return  p ? new(p) ::HGCSSpi0Info : new ::HGCSSpi0Info;
   }
   static void *newArray_HGCSSpi0Info(Long_t nElements, void *p) {
      return p ? new(p) ::HGCSSpi0Info[nElements] : new ::HGCSSpi0Info[nElements];
   }
   // Wrapper around operator delete
   static void delete_HGCSSpi0Info(void *p) {
      delete ((::HGCSSpi0Info*)p);
   }
   static void deleteArray_HGCSSpi0Info(void *p) {
      delete [] ((::HGCSSpi0Info*)p);
   }
   static void destruct_HGCSSpi0Info(void *p) {
      typedef ::HGCSSpi0Info current_t;
      ((current_t*)p)->~current_t();
   }
} // end of namespace ROOT for class ::HGCSSpi0Info
...
namespace ROOT {
   static TClass *vectorlEHGCSSpi0InfogR_Dictionary();
   static void vectorlEHGCSSpi0InfogR_TClassManip(TClass*);
   static void *new_vectorlEHGCSSpi0InfogR(void *p = 0);
   static void *newArray_vectorlEHGCSSpi0InfogR(Long_t size, void *p);
   static void delete_vectorlEHGCSSpi0InfogR(void *p);
   static void deleteArray_vectorlEHGCSSpi0InfogR(void *p);
   static void destruct_vectorlEHGCSSpi0InfogR(void *p);

   // Function generating the singleton type initializer
   static TGenericClassInfo *GenerateInitInstanceLocal(const vector<HGCSSpi0Info>*)
   {
      vector<HGCSSpi0Info> *ptr = 0;
      static ::TVirtualIsAProxy* isa_proxy = new ::TIsAProxy(typeid(vector<HGCSSpi0Info>));
      static ::ROOT::TGenericClassInfo 
         instance("vector<HGCSSpi0Info>", -2, "vector", 339,
                  typeid(vector<HGCSSpi0Info>), ::ROOT::Internal::DefineBehavior(ptr, ptr),
                  &vectorlEHGCSSpi0InfogR_Dictionary, isa_proxy, 4,
                  sizeof(vector<HGCSSpi0Info>) );
      instance.SetNew(&new_vectorlEHGCSSpi0InfogR);
      instance.SetNewArray(&newArray_vectorlEHGCSSpi0InfogR);
      instance.SetDelete(&delete_vectorlEHGCSSpi0InfogR);
      instance.SetDeleteArray(&deleteArray_vectorlEHGCSSpi0InfogR);
      instance.SetDestructor(&destruct_vectorlEHGCSSpi0InfogR);
      instance.AdoptCollectionProxyInfo(TCollectionProxyInfo::Generate(TCollectionProxyInfo::Pushback< vector<HGCSSpi0Info> >()));
      return &instance;
   }
   // Static variable to force the class initialization
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_DICT_(Init) = GenerateInitInstanceLocal((const vector<HGCSSpi0Info>*)0x0); R__UseDummy(_R__UNIQUE_DICT_(Init));

   // Dictionary for non-ClassDef classes
   static TClass *vectorlEHGCSSpi0InfogR_Dictionary() {
      TClass* theClass =::ROOT::GenerateInitInstanceLocal((const vector<HGCSSpi0Info>*)0x0)->GetClass();
      vectorlEHGCSSpi0InfogR_TClassManip(theClass);
   return theClass;
   }
...
namespace ROOT {
   // Wrappers around operator new
   static void *new_vectorlEHGCSSpi0InfogR(void *p) {
      return  p ? ::new((::ROOT::Internal::TOperatorNewHelper*)p) vector<HGCSSpi0Info> : new vector<HGCSSpi0Info>;
   }
   static void *newArray_vectorlEHGCSSpi0InfogR(Long_t nElements, void *p) {
      return p ? ::new((::ROOT::Internal::TOperatorNewHelper*)p) vector<HGCSSpi0Info>[nElements] : new vector<HGCSSpi0Info>[nElements];
   }
   // Wrapper around operator delete
   static void delete_vectorlEHGCSSpi0InfogR(void *p) {
      delete ((vector<HGCSSpi0Info>*)p);
   }
   static void deleteArray_vectorlEHGCSSpi0InfogR(void *p) {
      delete [] ((vector<HGCSSpi0Info>*)p);
   }
   static void destruct_vectorlEHGCSSpi0InfogR(void *p) {
      typedef vector<HGCSSpi0Info> current_t;
      ((current_t*)p)->~current_t();
   }
} // end of namespace ROOT for class vector<HGCSSpi0Info>
...
namespace ROOT {
   static TClass *vectorlEHGCSSFirstHadIntgR_Dictionary();
   static void vectorlEHGCSSFirstHadIntgR_TClassManip(TClass*);
   static void *new_vectorlEHGCSSFirstHadIntgR(void *p = 0);
   static void *newArray_vectorlEHGCSSFirstHadIntgR(Long_t size, void *p);
   static void delete_vectorlEHGCSSFirstHadIntgR(void *p);
   static void deleteArray_vectorlEHGCSSFirstHadIntgR(void *p);
   static void destruct_vectorlEHGCSSFirstHadIntgR(void *p);

   // Function generating the singleton type initializer
   static TGenericClassInfo *GenerateInitInstanceLocal(const vector<HGCSSFirstHadInt>*)
   {
      vector<HGCSSFirstHadInt> *ptr = 0;
      static ::TVirtualIsAProxy* isa_proxy = new ::TIsAProxy(typeid(vector<HGCSSFirstHadInt>));
      static ::ROOT::TGenericClassInfo 
         instance("vector<HGCSSFirstHadInt>", -2, "vector", 339,
                  typeid(vector<HGCSSFirstHadInt>), ::ROOT::Internal::DefineBehavior(ptr, ptr),
                  &vectorlEHGCSSFirstHadIntgR_Dictionary, isa_proxy, 4,
                  sizeof(vector<HGCSSFirstHadInt>) );
      instance.SetNew(&new_vectorlEHGCSSFirstHadIntgR);
      instance.SetNewArray(&newArray_vectorlEHGCSSFirstHadIntgR);
      instance.SetDelete(&delete_vectorlEHGCSSFirstHadIntgR);
      instance.SetDeleteArray(&deleteArray_vectorlEHGCSSFirstHadIntgR);
      instance.SetDestructor(&destruct_vectorlEHGCSSFirstHadIntgR);
      instance.AdoptCollectionProxyInfo(TCollectionProxyInfo::Generate(TCollectionProxyInfo::Pushback< vector<HGCSSFirstHadInt> >()));
      return &instance;
   }
   // Static variable to force the class initialization
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_DICT_(Init) = GenerateInitInstanceLocal((const vector<HGCSSFirstHadInt>*)0x0); R__UseDummy(_R__UNIQUE_DICT_(Init));

   // Dictionary for non-ClassDef classes
   static TClass *vectorlEHGCSSFirstHadIntgR_Dictionary() {
      TClass* theClass =::ROOT::GenerateInitInstanceLocal((const vector<HGCSSFirstHadInt>*)0x0)->GetClass();
      vectorlEHGCSSFirstHadIntgR_TClassManip(theClass);
   return theClass;
   }
...
namespace ROOT {
   // Wrappers around operator new
   static void *new_vectorlEHGCSSFirstHadIntgR(void *p) {
      return  p ? ::new((::ROOT::Internal::TOperatorNewHelper*)p) vector<HGCSSFirstHadInt> : new vector<HGCSSFirstHadInt>;
   }
   static void *newArray_vectorlEHGCSSFirstHadIntgR(Long_t nElements, void *p) {
      return p ? ::new((::ROOT::Internal::TOperatorNewHelper*)p) vector<HGCSSFirstHadInt>[nElements] : new vector<HGCSSFirstHadInt>[nElements];
   }
   // Wrapper around operator delete
   static void delete_vectorlEHGCSSFirstHadIntgR(void *p) {
      delete ((vector<HGCSSFirstHadInt>*)p);
   }
   static void deleteArray_vectorlEHGCSSFirstHadIntgR(void *p) {
      delete [] ((vector<HGCSSFirstHadInt>*)p);
   }
   static void destruct_vectorlEHGCSSFirstHadIntgR(void *p) {
      typedef vector<HGCSSFirstHadInt> current_t;
      ((current_t*)p)->~current_t();
   }
} // end of namespace ROOT for class vector<HGCSSFirstHadInt>
...
"/afs/cern.ch/user/n/nkasarag/PFCal/PFCalEE/userlib/",
0
    };
...
class __attribute__((annotate("$clingAutoload$HGCSSFirstHadInt.hh")))  HGCSSFirstHadInt;
class __attribute__((annotate("$clingAutoload$HGCSSpi0Info.hh")))  HGCSSpi0Info;
